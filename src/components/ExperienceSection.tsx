  ...
  const experiences = [
    {
      ...
      achievements: [
        ...
        'Implemented HIPAA/GDPR compliance measures for 3+ healthcare clients',
        'Automated CI/CD pipeline reducing deployment time by 60%',
        'Delivered 8+ critical healthcare projects on time and budget'
      ],
    ...
    },
    {
      ...
      achievements: [
        'Developed scalable web application architecture for 5+ enterprise clients',
        'Implemented real-time features improving user engagement by 40%',
        'Optimized performance resulting in 40% faster load times across 12+ projects',
        'Led technical architecture decisions for multi-million dollar platforms'
      ],
    ...
    },
    {
      ...
      achievements: [
        'Built AI-powered fraud detection system with 95% accuracy',
        'Reduced false positive rates by 30% saving $2M+ annually',
        'Processed over 1M transactions daily across 15+ financial institutions',
        'Implemented machine learning models detecting complex fraud patterns'
      ],
    ...
    },
    {
      ...
      achievements: [
        'Mentored 100+ students in web development across 4 years',
        'Developed comprehensive curriculum for full-stack development',
        'Achieved 90% student completion rate with 85% job placement success',
        'Created 20+ hands-on projects and coding challenges for practical learning'
      ],
    ...
    },
    {
      ...
      achievements: [
        'Delivered 25+ client projects on time and under budget',
        'Implemented enterprise search functionality handling 10M+ queries daily',
        'Led team of 3-5 developers in agile environment across multiple projects',
        'Built scalable e-commerce platforms serving 50K+ concurrent users'
      ],
