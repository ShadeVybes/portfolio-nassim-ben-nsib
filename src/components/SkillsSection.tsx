...
interface Skill {
  ...
  category: 'languages' | 'frontend' | 'backend' | 'cloud' | 'data' | 'soft';
  description?: string;
...
const skills: Skill[] = [
  ...
  { name: 'Jest', level: 'Advanced', icon: <TestTube className="w-5 h-5" />, category: 'frontend', description: 'Unit and integration testing framework', yearsOfExperience: '3+ years' },
  { name: 'Playwright', level: 'Intermediate', icon: <TestTube className="w-5 h-5" />, category: 'frontend', description: 'End-to-end testing for web applications', yearsOfExperience: '1+ years' },
  ...
  { name: 'API Design', level: 'Expert', icon: <Globe className="w-5 h-5" />, category: 'backend', description: 'RESTful and GraphQL API development', yearsOfExperience: '4+ years' },
  { name: 'Microservices', level: 'Expert', icon: <Layers className="w-5 h-5" />, category: 'backend', description: 'Distributed architecture and service design', yearsOfExperience: '3+ years' },
  { name: 'Supertest', level: 'Advanced', icon: <TestTube className="w-5 h-5" />, category: 'backend', description: 'HTTP assertion testing for APIs', yearsOfExperience: '2+ years' },

  // Cloud & DevOps
  { name: 'Docker', level: 'Expert', icon: <Layers className="w-5 h-5" />, category: 'cloud', description: 'Containerization and microservices deployment', yearsOfExperience: '3+ years' },
  { name: 'GitHub Actions', level: 'Expert', icon: <GitBranch className="w-5 h-5" />, category: 'cloud', description: 'CI/CD pipelines and workflow automation', yearsOfExperience: '3+ years' },
  { name: 'GitLab CI/CD', level: 'Advanced', icon: <GitBranch className="w-5 h-5" />, category: 'cloud', description: 'Continuous integration and deployment', yearsOfExperience: '2+ years' },
  { name: 'Azure', level: 'Advanced', icon: <Cloud className="w-5 h-5" />, category: 'cloud', description: 'Cloud services and AI fundamentals certified', yearsOfExperience: '2+ years' },
  { name: 'AWS', level: 'Advanced', icon: <Cloud className="w-5 h-5" />, category: 'cloud', description: 'Cloud infrastructure and services', yearsOfExperience: '2+ years' },
  { name: 'DevSecOps', level: 'Advanced', icon: <Shield className="w-5 h-5" />, category: 'cloud', description: 'Security integration in development lifecycle', yearsOfExperience: '2+ years' },
  { name: 'Grafana', level: 'Intermediate', icon: <Monitor className="w-5 h-5" />, category: 'cloud', description: 'Monitoring and observability dashboards', yearsOfExperience: '1+ years' },
  { name: 'Prometheus', level: 'Intermediate', icon: <Monitor className="w-5 h-5" />, category: 'cloud', description: 'Metrics collection and alerting', yearsOfExperience: '1+ years' },
  { name: 'SonarQube', level: 'Advanced', icon: <Shield className="w-5 h-5" />, category: 'cloud', description: 'Code quality and security analysis', yearsOfExperience: '2+ years' },
  { name: 'Git', level: 'Expert', icon: <GitBranch className="w-5 h-5" />, category: 'cloud', description: 'Version control and collaborative development', yearsOfExperience: '4+ years' },

  // Data & AI
  { name: 'MongoDB', level: 'Advanced', icon: <Database className="w-5 h-5" />, category: 'data', description: 'NoSQL document database and aggregation', yearsOfExperience: '3+ years' },
  { name: 'MySQL', level: 'Advanced', icon: <Database className="w-5 h-5" />, category: 'data', description: 'Relational database design and optimization', yearsOfExperience: '3+ years' },
  { name: 'PostgreSQL', level: 'Expert', icon: <Database className="w-5 h-5" />, category: 'data', description: 'Advanced SQL and database administration', yearsOfExperience: '3+ years' },
  { name: 'Prisma', level: 'Advanced', icon: <Database className="w-5 h-5" />, category: 'data', description: 'Modern ORM with type safety', yearsOfExperience: '2+ years' },
  { name: 'TypeORM', level: 'Advanced', icon: <Database className="w-5 h-5" />, category: 'data', description: 'TypeScript ORM for Node.js applications', yearsOfExperience: '2+ years' },
  { name: 'Machine Learning', level: 'Intermediate', icon: <Brain className="w-5 h-5" />, category: 'data', description: 'Data analysis and predictive modeling', yearsOfExperience: '2+ years' },
  { name: 'TensorFlow', level: 'Intermediate', icon: <Brain className="w-5 h-5" />, category: 'data', description: 'Deep learning and neural networks', yearsOfExperience: '1+ years' },
  { name: 'Genetic Algorithm', level: 'Intermediate', icon: <Brain className="w-5 h-5" />, category: 'data', description: 'Optimization and evolutionary computing', yearsOfExperience: '1+ years' },
  { name: 'OCR (AWS Textract)', level: 'Advanced', icon: <Brain className="w-5 h-5" />, category: 'data', description: 'Optical character recognition and document analysis', yearsOfExperience: '2+ years' },
  { name: 'Jupyter', level: 'Advanced', icon: <Code className="w-5 h-5" />, category: 'data', description: 'Interactive development and data analysis', yearsOfExperience: '2+ years' },
  ...
  { name: 'Arabic', level: 'Expert', icon: <Languages className="w-5 h-5" />, category: 'soft', description: 'Native speaker' },
  { name: 'English', level: 'Expert', icon: <Languages className="w-5 h-5" />, category: 'soft', description: 'Professional proficiency' },
  { name: 'French', level: 'Advanced', icon: <Languages className="w-5 h-5" />, category: 'soft', description: 'Professional proficiency' },
  { name: 'Agile/Scrum', level: 'Advanced', icon: <Users className="w-5 h-5" />, category: 'soft', description: 'Project management and team collaboration', yearsOfExperience: '4+ years' },
  { name: 'Technical Writing', level: 'Advanced', icon: <Code className="w-5 h-5" />, category: 'soft', description: 'Documentation and knowledge sharing', yearsOfExperience: '3+ years' },
  { name: 'HIPAA/GDPR', level: 'Advanced', icon: <Shield className="w-5 h-5" />, category: 'soft', description: 'Healthcare and data privacy compliance', yearsOfExperience: '2+ years' },
  { name: 'n8n Workflows', level: 'Advanced', icon: <Settings className="w-5 h-5" />, category: 'soft', description: 'Workflow automation and integration', yearsOfExperience: '2+ years' },
  { name: 'RPA', level: 'Intermediate', icon: <Cpu className="w-5 h-5" />, category: 'soft', description: 'Robotic process automation', yearsOfExperience: '1+ years' },
];
    ...
    <section id="skills" className="py-20 bg-gray-950/50 backdrop-blur-sm">
      <div className="container mx-auto px-6">
        ...
        <Tabs value={activeCategory} onValueChange={setActiveCategory} className="w-full">
          <TabsList className="grid w-full grid-cols-3 lg:grid-cols-6 mb-12 bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 h-auto p-1">
